...
const AIDoctor = () => {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [
        ...prev,
        {from: 'ai', text: isUrdu ? 'Main aap ki baat samajh raha hoon. Detailed jawab jald milega.'
            : 'I understand your concern. A detailed response will be provided shortly.'}])}, 800)}
  return (
      ...
      <div className="max-w-4xl px-4 py-6 mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col h-[70vh]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleSend}
              className="p-3 text-white bg-blue-600 hover:bg-blue-700 rounded-xl">
